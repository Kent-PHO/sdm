...
1.  The model simulates core population dynamics, including **births, ageing, and deaths**, across time steps.
2.  At each time step, the model calculates disease incidence and mortality using fixed rates stratified by age, sex, and condition.
